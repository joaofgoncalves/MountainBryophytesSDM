...
#   assign(climProjName, projectRaster(get(climProjName),current, method = "ngb"))
#   # 
#   # assign(climProjName,`names<-`(get(climProjName), 
#   #                               c(paste("BIO",c(11,17,19),sep=""),"ASPBR","TOPRI","SOIPH")))
#   
#   writeRaster(get(climProjName), filename = paste("./DATA/RASTER/Clim/",climProjName,"_proj_BIO_11_17_19.tif",sep=""),
#               overwrite=TRUE)
#   
# }
# 
# he45bi50 <- stack(stack("./DATA/RASTER/Clim/he45bi50_proj_BIO_11_17_19.tif"),
#                   stack(topoVarsPaths,soilVarsPaths))
# names(he45bi50) <- c(paste("BIO",c(11,17,19),sep=""),"ASPBR","TOPRI","SOIPH")
# 
# 
# he85bi50 <- stack(stack("./DATA/RASTER/Clim/he85bi50_proj_BIO_11_17_19.tif"),
#                   stack(topoVarsPaths,soilVarsPaths))
# names(he85bi50) <- c(paste("BIO",c(11,17,19),sep=""),"ASPBR","TOPRI","SOIPH")
# 
# 
# mp45bi50 <- stack(stack("./DATA/RASTER/Clim/mp45bi50_proj_BIO_11_17_19.tif"),
#                   stack(topoVarsPaths,soilVarsPaths))
# names(mp45bi50) <- c(paste("BIO",c(11,17,19),sep=""),"ASPBR","TOPRI","SOIPH")
# 
# 
# mp85bi50 <- stack(stack("./DATA/RASTER/Clim/mp85bi50_proj_BIO_11_17_19.tif"),
#                   stack(topoVarsPaths,soilVarsPaths))
